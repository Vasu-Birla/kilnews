...
// // // 🖼️ Media Renderer Helper Component (Same Layout)
...
// //         if (res?.success) {
// //           // ✅ Filtering ONLY "Lifestyle" category
// //           const lifestyleNews = res?.data?.filter(
// //             (item) =>
// //               item?.category?.name?.toLowerCase() === "lifestyle" ||
// //               item?.category?.name === "लाइफस्टाइल"
// //           );
// //           setNewsData(lifestyleNews || []);
// //         } else {
// //           setError(res?.message || "Failed to load lifestyle news.");
// //         }
// //       } catch (err) {
// //         setError(err.message || "An error occurred while fetching lifestyle news.");
// //       } finally {
// //         setLoading(false);
// //       }
// //     };
...
// //         <p className="mt-2">Lifestyle समाचार लोड हो रहे हैं...</p>
// //       </div>
// //     );
// //   }
...
// //               className="me-2"
// //             ></div>
// //             <h5 className="fw-bold m-0">Lifestyle</h5>
// //           </div>
// //           <hr
...
// //           कोई Lifestyle समाचार उपलब्ध नहीं है।
// //         </Alert>
// //       </Container>
// //     );
// //   }

// //   // 📰 News Distribution Logic (Same as Business/Articles)
...
// //                 alt={mainArticle?.title_hi || mainArticle?.title_en || "Lifestyle News"}
// //                 width="100%"
// //                 height="320px"
// //                 objectFit="cover"
// //                 borderRadius="8px"
...
// //                     alt={bottomArticle?.title_hi || bottomArticle?.title_en || "Lifestyle News"}
// //                     width="100%"
// //                     height="90px"
// //                     objectFit="cover"
// //                     borderRadius="8px"
...
// //                     <MediaRenderer
// //                       media={article?.media}
// //                       alt={article?.title_hi || article?.title_en || "Lifestyle News"}
// //                       width="100%"
// //                       height="90px"
// //                       objectFit="cover"
// //                       borderRadius="8px"
...
//             className="me-2"
//           ></div>
//           <h5 className="fw-bold m-0">लाइफस्टाइल</h5>
//         </div>
//         <hr
//           className="flex-grow-1 mx-3"
//           style={{ borderTop: `2px solid ${accentColor}`, opacity: 1 }}
...
const LifestyleSection = () => {
  ...
  const newsData = categorized["lifestyle"] || categorized["लाइफस्टाइल"] || [];
  ...
  return (
    <Container fluid className="mt-4">
      ...
      {newsData.length === 0 ? (
        <Alert variant="info" className="my-4">कोई Lifestyle समाचार उपलब्ध नहीं है।</Alert>
      ) : (
        <Row>
          {/* Left Column */}
          <Col lg={7} className="mb-4 mb-lg-0 d-flex flex-column">
