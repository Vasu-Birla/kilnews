...
//         if (res?.success) {
//           // ✅ Filtering Logic: Only Astrology
//           const astroNews = res.data.filter((item) => {
//             const categoryName = item.category?.name?.toLowerCase() || "";
//             // केवल कैटेगरी चेक करें
//             return categoryName === "astrology" || categoryName === "ज्योतिष";
//           });

//           setNewsData(astroNews || []);
//         } else {
//           setError(res?.message || "Failed to load Astrology news.");
//         }
//       } catch (err) {
...
//             className="me-2"
//           ></div>
//           <h5 className="fw-bold m-0">ज्योतिष</h5>
//         </div>
//         <hr
...
//           कोई Astrology समाचार उपलब्ध नहीं है।
//         </Alert>
//       ) : (
//         <Row>
...
//                   alt={mainArticle?.title_hi || mainArticle?.title_en || "Astrology News"}
//                   width="100%"
//                   height="320px"
//                   objectFit="cover"
//                   borderRadius="8px"
...
//                   {/* ✅ User Avatar Added Here (White Text for Overlay) */}
...
//                       alt={bottomArticle?.title_hi || bottomArticle?.title_en || "Astrology News"}
//                       width="100%"
//                       height="90px"
//                       objectFit="cover"
//                       borderRadius="8px"
...
//                       <MediaRenderer
//                         media={article?.media}
//                         alt={article?.title_hi || article?.title_en || "Astrology News"}
//                         width="100%"
//                         height="90px"
//                         objectFit="cover"
//                         borderRadius="8px"
...
const AstrologySection = () => {
  // ✅ Apna fetch, useState(loading), useState(error), useEffect — sab hata diya.
  // Ab sirf Context se data milega, jo NewsPage mein EK BAAR fetch hota hai.
  const { categorized, loading, error } = useNews();
  const newsData = categorized["astrology"] || categorized["ज्योतिष"] || [];
