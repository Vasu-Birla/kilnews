...
export const getAllAppVideos = async (req, res, next) => {
  try {
    let currentUserId = null;
  ...
  try {
    ...
    if (userId) {
      ...
      return res.status(200).json({
        ...
        totalLikes: video.likes.length + video.guestLikes.length,
        isLiked,
      });
    }
